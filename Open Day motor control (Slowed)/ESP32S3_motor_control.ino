...
void setup() {
  ...
  stepper1.setMaxSpeed(8000);      // 8000 works with 1000 accel
  stepper1.setAcceleration(1000);

  // --- MOTOR 2 SETTINGS (Shoulder) ---
  stepper2.setMaxSpeed(10000);     // 6000
  stepper2.setAcceleration(4000); //1200

  // --- MOTOR 3 SETTINGS (Elbow) ---
  stepper3.setMaxSpeed(10000);     // 6000
  stepper3.setAcceleration(4000); //1200
  ...
  // writeServoUs(600);   // start gripper fully closed to prevent collisions! (was gripperServo.write(5))
  ...
  // -> prismatic joint drops down 
    ...
    case STATE_PICKUP_DESCEND:
      ...
      if (motorsIdle(true, false, false)) {
        ...
        closeGripper();  // fully closed (was gripperServo.write(5))
